...
public class ProductManagerDashboard extends BaseDashboard {

    private final DBconn.DatabaseConnection db = new DBconn.DatabaseConnection();

    public ProductManagerDashboard(String username, int roleId) { super(username, roleId); }
    ...
    protected void createSidebar() {
        ...
        sidebar.add(makeUserPanel("Product Manager", ModernTheme.PRODUCT_MANAGER_COLOR));
    ...
    private JPanel build_dashboard() {
        ...
        JLabel ttl = new JLabel("Product Manager Dashboard"); ttl.setFont(ModernTheme.TITLE_FONT); ttl.setForeground(ModernTheme.DARK_TEXT);
        ...
        stats.add(new StatCard("Features","42","🎯",ModernTheme.PRODUCT_MANAGER_COLOR));
        stats.add(new StatCard("User Stories","118","📖",ModernTheme.INFO));
        stats.add(new StatCard("Sprint","3","🔄",ModernTheme.WARNING));
        stats.add(new StatCard("NPS","72","😊",ModernTheme.SUCCESS));
        stats.add(new StatCard("Backlog","31","📋",ModernTheme.CODER_COLOR));
        stats.add(new StatCard("Releases","5","🚀",ModernTheme.SUCCESS));
    ...
    private JPanel build_tasks() {
        ...
        ModernButton load = new ModernButton("Load My Tasks", ModernTheme.PRODUCT_MANAGER_COLOR);
    ...
    private JPanel build_messages() {
        ...
        ModernButton sendBtn=new ModernButton("Send",ModernTheme.PRODUCT_MANAGER_COLOR); sendBtn.setPreferredSize(new Dimension(120,38));
        ...
        ModernButton refresh=new ModernButton("Refresh Inbox",ModernTheme.PRODUCT_MANAGER_COLOR); refresh.setPreferredSize(new Dimension(160,36));
